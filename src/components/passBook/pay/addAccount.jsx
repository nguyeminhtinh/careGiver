...
class addAccount extends Component {
	...
	submitAddCartNumber = () =>{
		...
		var idUser = toJS(this.props.rootStore.userStore).user.id;
		this.setState({ 
			isLoading: true,
			modalIsOpens: ""
		}, () => {
			this.props.rootStore.paymentStore.createCardStore(idUser, bodyCard).then(data => {
				var message = data.message;
			...
			<div className="wrapper">
				...
				>
					...
					<div className="pop-content normal pre-line">
						<p>자주 사용하는 계좌로 등록하시겠습니까?</p>
					</div>
					<div className="pop-footer btn-2">
						<button
							className="agree"
							onClick={this.submitAddCartNumber}
						>예</button>
						<button
							className="cancel"
